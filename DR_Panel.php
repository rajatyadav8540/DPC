...
<head>
  ...
  <title>Dr.Bharat's Patel clinic</title>
  ...
  <link href="./css/dr_panel_style.css" rel="stylesheet">
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="DR_Panel.php">Yagyik Shrivastava</a></h1>
  ...
  <script src="./js/main_drpanel.js"></script>
