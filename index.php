<?php include 'header.php' ?>
                          ...
                          <div class="text-contant">
                            <h2>
                              ...
                              <a href="" class="typewrite" data-period="2000"
                                data-type='[ "Welcome to Patel Clinic", "We Care Your Health", "We are Expert!" ]'>
                        ...
                        <div class="row">
                          <div class="service-time middle" style="background:#0071d1;">
                            ...
                            <div class="time-table-section">
                              <ul>
                                <li><span class="center">Monday - Saturday</span></li>
                                <li><span class="left">10:00 am-02:00 pm</span><span class="right">03:00 pm-09:00
                                    pm</span></li>
                                <li><span class="left">Sunday</span><span class="right">10.00AM – 02.00PM</span></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="message-box">
                            ...
                            <p class="lead">DPC has been providing health services to people in need for the past 14
                              years. We provide a wide range of state-of-the-art medicines for diagnostic and
                              therapeutic purposes, with care and compassion. We believe that medication and personal
                              care are a good combination to help people recover faster and better.</p>
                            <a href="About1.php" data-scroll
                              class="btn btn-light btn-radius btn-brd grd1 effect-1">Learn More</a>
                          </div>
                          <!-- end messagebox -->
                        </div>
                        <!-- end col -->
                  ...
                  <div id="doctors" class="parallax section db" data-stellar-background-ratio="0.4"
                    style="background:#fff;" data-scroll-id="doctors" tabindex="-1">
                    <div class="container">
                      ...
                      <div class="row dev-list text-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn " data-wow-duration="1s"
                          data-wow-delay="0.4s"
                          style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn; display:inline-block;">
                          <div class="widget clearfix">
                            <img src="images/profile.png" alt="" class="img-responsive img-rounded">
                            <div class="widget-title">
                              <h3>Dr. Bharat Kumar D. Dholu-Patel</h3>
                              <small>MBBS,MD-Physician, FCPS-Medicine Consultant Preventive Diabetes & Cardiovascular
                                Diseases</small>
                            </div>
                            <!-- end title -->
                  ...
                  <div id="testimonials" class="section wb wow fadeIn">
                    <div class="container">
                      <div class="heading">
                        <span class="icon-logo"><img src="images/profile.png" alt="#"></span>
                        <h2>Testimonials</h2>
                      </div>
                      <!-- end title -->
                      <div class="row">
                        <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                          <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                              <img src="images/profile.png" alt="" class="img-responsive alignleft">
                              <h4>Rakesh Kumar <small>- Manager of Racer</small></h4>
                            </div>
                            <!-- end testi-meta -->
                          </div>
                          <!-- end testimonial -->
                        ...
                        <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                          <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                              <img src="images/profile.png" alt="" class="img-responsive alignleft">
                              <h4>Milan Ahuja <small>- Life Manager</small></h4>
                            </div>
                            <!-- end testi-meta -->
                          </div>
                          <!-- end testimonial -->
